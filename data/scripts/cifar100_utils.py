...
if __name__ == '__main__':
    ...
    #     "../cifar100/paths", "../cifar100/images", "../triggers/trigger_10.png", 0.3, 0.6, 0.3, 42
    # )
    # create_poison_data_train('../cifar100/paths', '../cifar100/images', '../triggers/trigger_10.png', 0.3, 0.6, 0, 42, 64)
    # create_poison_data_train('../cifar100/paths', '../cifar100/images', '../triggers/trigger_10.png', 0.3, 0.6, 0, 42, 32)
    # create_poison_data_train('../cifar100/paths', '../cifar100/images', '../triggers/trigger_10.png', 0.3, 0.6, 0, 42, 16)
    # create_poison_data_train('../cifar100/paths', '../cifar100/images', '../triggers/trigger_10.png', 0.3, 0.6, 0, 42, 8)
    # create_poison_data_train('../cifar100/paths', '../cifar100/images', '../triggers/trigger_10.png', 0.3, 0.6, 0, 42, 4)
    # create_poison_data_train('../cifar100/paths', '../cifar100/images', '../triggers/trigger_10.png', 0.3, 0.6, 0, 42, 2)